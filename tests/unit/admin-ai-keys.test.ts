...
describe('Admin AI Keys Page', () => {
	...
	it('should render the page title', () => {
		render(AIKeysPage, { props: { data: { user: mockUser, canRevealPii: false, piiRevealed: false, hasAIProviders: false, cmsPaletteItems: [], keys: [] } } });
	...
	it('should render a list of existing AI keys', () => {
		...
		render(AIKeysPage, { props: { data: { user: mockUser, canRevealPii: false, piiRevealed: false, hasAIProviders: false, cmsPaletteItems: [], keys: mockKeys } } });
