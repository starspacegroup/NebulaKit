...
describe('Admin Users Page', () => {
	...
	it('should render the page title', () => {
		render(UsersPage, { props: { data: { user: mockUser, hasAIProviders: false, cmsPaletteItems: [], users: [] } } });
	...
	it('should render a list of existing users', () => {
		...
		render(UsersPage, { props: { data: { user: mockUser, hasAIProviders: false, cmsPaletteItems: [], users: mockUsers } } });
